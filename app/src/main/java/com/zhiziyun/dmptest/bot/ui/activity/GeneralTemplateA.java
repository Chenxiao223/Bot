...
public class GeneralTemplateA extends BaseActivity implements View.OnClickListener {
    ...
    private ImageView iv_a, iv_b;
    private String SIZE;//模板尺寸
    private EditText et_title, et_text, et_title2, et_text2, edit_url, edit_ur2;
    private LinearLayout line1, line2;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_general_template_a);
        initView();
    }
...
//            iv_b.setLayoutParams(params2);
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ToastUtils.showShort(GeneralTemplateA.this, "图片上传成功");
                    dialog.dismiss();
                    finish();
                    break;
                case 2:
                    ToastUtils.showShort(GeneralTemplateA.this, "图片上传失败");
                    dialog.dismiss();
                    break;
            }
        }
