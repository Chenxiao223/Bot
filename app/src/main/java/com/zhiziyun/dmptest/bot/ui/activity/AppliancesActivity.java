...
public class AppliancesActivity extends BaseActivity implements View.OnClickListener {
    ...
    private ImageView iv_left, iv_right, iv_picture;
    private int flag = 0;
    private int flag_iv = 0;//区分改变哪张图
    private Uri cropImageUri;
    private Handler mHandler = new Handler();
    private RelativeLayout layout_1, layout_2, layout_3;
    private EditText et_title, et_text, edit_url, edit_url2, et_title2, et_text2, edit_url3;
    ...
    private void initView() {
        ...
        if (flag == 1) {//那边点击了那个模板，这边就显示这个模板
            ...
            //设置图片的长高
            RelativeLayout.LayoutParams params2 = (RelativeLayout.LayoutParams) iv_left.getLayoutParams();
            params2.width = dm.widthPixels * 10 / 64;
            params2.height = dm.widthPixels * 10 / 64;
            iv_left.setLayoutParams(params2);
            RelativeLayout.LayoutParams params3 = (RelativeLayout.LayoutParams) iv_right.getLayoutParams();
            params3.width = dm.widthPixels * 10 / 64;
            params3.height = dm.widthPixels * 10 / 64;
            iv_right.setLayoutParams(params3);
        } else if (flag == 2) {
                        ...
                        public void run() {
                            ...
                            if (flag == 1) {//区分模板
                                if (TextUtils.isEmpty(edit_url.getText().toString())) {
                                    ToastUtils.showShort(AppliancesActivity.this, "请将URL填写完整");
                                } else {
                                    //加载动画
                                    dialog.show();
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ToastUtils.showShort(AppliancesActivity.this, "图片上传成功");
                    dialog.dismiss();
                    finish();
                    break;
                case 2:
                    ToastUtils.showShort(AppliancesActivity.this, "图片上传失败");
                    break;
            }
        }
    };
