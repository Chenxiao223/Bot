...
public class ChooseCrowdActivity extends BaseActivity implements View.OnClickListener {
        ...
        smartRefreshLayout.setOnLoadmoreListener(new OnLoadmoreListener() {
            ...
            public void onLoadmore(RefreshLayout refreshlayout) {
                if ((crowd.getResponse().getTotal() - (page - 1) * 10) > 0) {
                    requestCrowd(page);
                    ToastUtils.showShort(ChooseCrowdActivity.this, page + "/" + ((crowd.getResponse().getTotal() / 10) + 1));
                } else {
                    ToastUtils.showShort(ChooseCrowdActivity.this, "最后一页了");
                ...
                case 1:
                    try {
                        if (crowd.getResponse().getData().size() == 0) {
                            ...
                            dialog.dismiss();
                            smartRefreshLayout.finishLoadmore(0);//停止刷新
                            ToastUtils.showShort(ChooseCrowdActivity.this, "无数据");
                        } else {
                        ...
                        cbAdapter = new CheckBoxAdapter(ChooseCrowdActivity.this, list);
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_add_crowd:
                if (intent.getIntExtra("flags", 0) == 1) {
                    startActivity(new Intent(ChooseCrowdActivity.this, AddCorwdActivity.class));
                } else if (intent.getIntExtra("flags", 0) == 2) {
                    startActivity(new Intent(ChooseCrowdActivity.this, AddWifiCorwdActivity.class));
                } else if (intent.getIntExtra("flags", 0) == 3) {
                    startActivity(new Intent(ChooseCrowdActivity.this, AddAdvertisingCrowd.class));
                }
                break;
            case R.id.tv_commit:
                try {
                    if (listStr.size() == 0) {
                        ToastUtils.showShort(ChooseCrowdActivity.this, "请选择人群");
                    } else {
                        //从添加广告活动进来
