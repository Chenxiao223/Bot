...
public class ChildrenActivity extends BaseActivity implements View.OnClickListener {
    ...
    private ImageView iv_picture, iv_picture2;
    private int flag = 0;
    private int flag_iv = 0;//区分改变哪张图
    private Uri cropImageUri;
    private Handler mHandler = new Handler();
    private RelativeLayout layout_1, layout_2;
    private EditText et_title, et_text, edit_url, et_text2, et_text3, edit_url2;
    ...
    private void initView() {
        ...
        if (flag == 1) {
            ...
            params1.setMargins(dm.widthPixels * 385 / 720, 0, 0, 0);
            iv_picture.setLayoutParams(params1);
            RelativeLayout.LayoutParams params2 = (RelativeLayout.LayoutParams) btn_left.getLayoutParams();
            params2.setMargins(dm.widthPixels * 385 / 720, 0, 0, 0);
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ToastUtils.showShort(ChildrenActivity.this, "图片上传成功");
                    dialog.dismiss();
                    finish();
                    break;
                case 2:
                    ToastUtils.showShort(ChildrenActivity.this, "图片上传失败");
                    dialog.dismiss();
                    break;
            }
        }
