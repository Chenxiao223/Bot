 ...
 * 饼状图表
 */
public class PieChart_sex extends View {
    /**
     * 视图的宽和高
     */
    ...
    public PieChart_sex(Context context) {
        super(context);
        init(context);
    }

    public PieChart_sex(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PieChart_sex(Context context, AttributeSet attrs, int defStyleAttr) {
