 ...
 * 饼状图表
 */
public class PieChart_mpb extends View {
    /**
     * 视图的宽和高
     */
    ...
    public PieChart_mpb(Context context) {
        super(context);
        init(context);
    }

    public PieChart_mpb(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PieChart_mpb(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                canvas.drawText(resToRound+"%",pxt+30,pyt,mTextPaint);
    ...
    private void check(Canvas canvas,boolean flag,int i,double resToRound,float pxt,float pyt){
        switch (i){
            case 0:
                if (flag==true) {
                    canvas.drawText(VisitorsViewFragment.visitorsViewFragment.list_brand.get(0), pxt - mTextPaint.measureText(resToRound + "%") - 30, pyt, mTextPaint);
                }else{
                    canvas.drawText(VisitorsViewFragment.visitorsViewFragment.list_brand.get(0), pxt + 30, pyt, mTextPaint);
                }
                break;
            case 1:
                if (flag==true) {
                    canvas.drawText(VisitorsViewFragment.visitorsViewFragment.list_brand.get(1), pxt - mTextPaint.measureText(resToRound + "%") - 30, pyt, mTextPaint);
                }else{
                    canvas.drawText(VisitorsViewFragment.visitorsViewFragment.list_brand.get(1), pxt + 30, pyt, mTextPaint);
                }
                break;
            case 2:
                if (flag==true) {
                    canvas.drawText(VisitorsViewFragment.visitorsViewFragment.list_brand.get(2), pxt - mTextPaint.measureText(resToRound + "%") - 30, pyt, mTextPaint);
                }else{
                    canvas.drawText(VisitorsViewFragment.visitorsViewFragment.list_brand.get(2), pxt + 30, pyt, mTextPaint);
                }
                break;
            case 3:
                if (flag==true) {
                    canvas.drawText(VisitorsViewFragment.visitorsViewFragment.list_brand.get(3), pxt - mTextPaint.measureText(resToRound + "%") - 30, pyt, mTextPaint);
                }else{
                    canvas.drawText(VisitorsViewFragment.visitorsViewFragment.list_brand.get(3), pxt + 30, pyt, mTextPaint);
                }
                break;
            case 4:
                if (flag==true) {
                    canvas.drawText(VisitorsViewFragment.visitorsViewFragment.list_brand.get(4), pxt - mTextPaint.measureText(resToRound + "%") - 30, pyt, mTextPaint);
                }else{
                    canvas.drawText(VisitorsViewFragment.visitorsViewFragment.list_brand.get(4), pxt + 30, pyt, mTextPaint);
                }
                break;
            case 5:
                if (flag==true) {
                    canvas.drawText(VisitorsViewFragment.visitorsViewFragment.list_brand.get(5), pxt - mTextPaint.measureText(resToRound + "%") - 30, pyt, mTextPaint);
                }else{
                    canvas.drawText(VisitorsViewFragment.visitorsViewFragment.list_brand.get(5), pxt + 30, pyt, mTextPaint);
                }
                break;
        }
    }
