 ...
 * 饼状图表
 */
public class PieChart_age extends View {
    /**
     * 视图的宽和高
     */
    ...
    public PieChart_age(Context context) {
        super(context);
        init(context);
    }

    public PieChart_age(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PieChart_age(Context context, AttributeSet attrs, int defStyleAttr) {
