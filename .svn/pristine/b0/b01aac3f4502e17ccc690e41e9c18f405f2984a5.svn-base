...
public class ClickCrowdFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_click_crowd, container, false);
    }
    ...
    private void initView() {
        ...
        adapter.setDetails(new CrowdAdapter.Details() {
            ...
            public void setDetails(String id, int position) {
                Intent it = new Intent(getActivity(), AddAdvertisingCrowd.class);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    RequestBody body = RequestBody.create(mediaType, url);
                    final Request request = new Request.Builder()
                            .url(BaseUrl.BaseTest + "adClickSegmentInfo/insertTask")
                            .post(body)
                            .addHeader("content-type", "application/x-www-form-urlencoded")
                            .build();
