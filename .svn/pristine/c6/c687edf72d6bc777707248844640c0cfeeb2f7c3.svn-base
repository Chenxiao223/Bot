        ...
        smartRefreshLayout.setOnLoadmoreListener(new OnLoadmoreListener() {
            ...
            public void onLoadmore(RefreshLayout refreshlayout) {
                if ((crowd.getResponse().getTotal() - (page - 1) * 10) > 0) {
                    ...
                    ToastUtils.showShort(CrowdActivity.this, "最后一页了");
            ...
            switch (msg.what) {
                case 1:
                    if (crowd.getResponse().getData().size() == 0) {
                        ...
                        dialog.dismiss();
                        smartRefreshLayout.finishLoadmore(0);//停止刷新
                        ToastUtils.showShort(CrowdActivity.this, "无数据");
                    } else {
                    ...
                    cbAdapter = new CheckBoxAdapter(CrowdActivity.this, list);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_add_crowd:
                startActivity(new Intent(CrowdActivity.this, AddCorwdActivity.class));
                break;
            case R.id.tv_commit:
                if (listStr.size() == 0) {
