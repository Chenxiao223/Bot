...
public class GeneralTemplateC extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_general_template_c);
        initView();
    }
...
//            iv_b.setLayoutParams(params2);
                ...
                if (ClickUtils.isFastClick()) {
                    ...
                    if (flag == 1) {//区分模板
                        if (TextUtils.isEmpty(edit_url.getText().toString())) {
                            ToastUtils.showShort(GeneralTemplateC.this, "请将URL填写完整");
                        } else {
                            //加载动画
                            dialog.show();
                            final Bitmap bitmap = layout_1.getDrawingCache(); // 获取图片
                            Bitmap bmp = zoomImg(bitmap, 728, 90);
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ToastUtils.showShort(GeneralTemplateC.this, "图片上传成功");
                    dialog.dismiss();
                    finish();
                    break;
                case 2:
                    ToastUtils.showShort(GeneralTemplateC.this, "图片上传失败");
                    dialog.dismiss();
                    break;
            }
        }
