...
public class FinancialActivity extends BaseActivity implements View.OnClickListener {
                        ...
                        public void run() {
                            ...
                            if (flag == 1) {//区分模板
                                if (TextUtils.isEmpty(edit_url1.getText().toString())) {
                                    ToastUtils.showShort(FinancialActivity.this, "请将URL填写完整");
                                } else {
                                    //加载动画
                                    dialog.show();
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ToastUtils.showShort(FinancialActivity.this, "图片上传成功");
                    dialog.dismiss();
                    finish();
                    break;
                case 2:
                    ToastUtils.showShort(FinancialActivity.this, "图片上传失败");
                    dialog.dismiss();
                    break;
            }
        }
