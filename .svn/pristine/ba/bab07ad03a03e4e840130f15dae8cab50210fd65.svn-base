        ...
        switch (v.getId()) {
            ...
            case R.id.rl_crowd:
                ...
                if (list_corwd.isEmpty()) {//无值
                    Intent it_crowd = new Intent(CrowdSourceActivity.this, CrowdActivity.class);
            ...
            case R.id.rl_wifi_crowd:
                ...
                if (list_wifi_corwd.isEmpty()) {//无值
                    Intent it_wifi_crowd = new Intent(CrowdSourceActivity.this, CrowdActivity.class);
            ...
            case R.id.rl_click_crowd:
                ...
                if (list_click_corwd.isEmpty()) {//无值
                    Intent it_click_crowd = new Intent(CrowdSourceActivity.this, CrowdActivity.class);
