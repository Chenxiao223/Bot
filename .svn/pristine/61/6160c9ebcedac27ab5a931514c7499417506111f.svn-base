    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_a://添加到店人群
                CrowdFragment.crowdFragment.startActivity(new Intent(mContext, AddCorwdActivity.class));
                dismiss();
                break;
            ...
            case R.id.tv_c://添加wifi人群
                if (!isWifiConnected(mContext)) {
                    ...
                    CrowdFragment.crowdFragment.startActivity(new Intent(mContext, AddWifiCorwdActivity.class));
                }
                dismiss();
                break;
        }
