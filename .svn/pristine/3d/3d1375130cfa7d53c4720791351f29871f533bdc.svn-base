...
public class EducationActivity extends BaseActivity implements View.OnClickListener {
    ...
    private EditText et_text2, et_text1, edit_url1, et_text3, et_text4, edit_url2, edit_url3, edit_url4;
                        ...
                        public void run() {
                            ...
                            if (flag == 1) {//区分模板
                                if (TextUtils.isEmpty(edit_url1.getText().toString())) {
                                    ToastUtils.showShort(EducationActivity.this, "请将URL填写完整");
                                } else {
                                    //加载动画
                                    dialog.show();
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ToastUtils.showShort(EducationActivity.this, "图片上传成功");
                    dialog.dismiss();
                    finish();
                    break;
                case 2:
                    ToastUtils.showShort(EducationActivity.this, "图片上传失败");
                    dialog.dismiss();
                    break;
            }
        }
