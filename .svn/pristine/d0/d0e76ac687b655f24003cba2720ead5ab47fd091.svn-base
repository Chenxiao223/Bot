...
public class SeedsCrowdActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        btn_commit = findViewById(R.id.bt_commit);
        btn_commit.setText("完 成");
        ...
        switch (v.getId()) {
            ...
            case R.id.rl_crowd:
                ...
                if (list_corwd.isEmpty()) {//无值
                    Intent it_crowd = new Intent(SeedsCrowdActivity.this, SeedsCrowdChooseActivity.class);
            ...
            case R.id.rl_wifi_crowd:
                ...
                if (list_wifi_corwd.isEmpty()) {//无值
                    Intent it_wifi_crowd = new Intent(SeedsCrowdActivity.this, CrowdActivity.class);
            ...
            case R.id.rl_click_crowd:
                ...
                if (list_click_corwd.isEmpty()) {//无值
                    Intent it_click_crowd = new Intent(SeedsCrowdActivity.this, CrowdActivity.class);
            ...
            case R.id.bt_commit:
                try {
                    if (list_corwd.isEmpty() && list_wifi_corwd.isEmpty() && list_click_corwd.isEmpty()) {
                        ToastUtils.showShort(SeedsCrowdActivity.this, "请选择人群");
                    } else {
