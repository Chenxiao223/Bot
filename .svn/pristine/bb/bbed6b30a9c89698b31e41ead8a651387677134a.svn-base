...
public class GameActivity extends BaseActivity implements View.OnClickListener {
    ...
    private EditText et_title1, et_text1, edit_url1, edit_url2;
    ...
    private void initView() {
        ...
        if (flag == 1) {//那边点击了那个模板，这边就显示这个模板
            ...
            params1.setMargins(0, 0, dm.widthPixels * 27 / 720, 0);//4个参数按顺序分别是左上右下
            ...
            params2.setMargins(0, 0, dm.widthPixels * 27 / 720, 0);//4个参数按顺序分别是左上右下
        } else if (flag == 2) {
                        ...
                        public void run() {
                            ...
                            if (flag == 1) {//区分模板
                                if (TextUtils.isEmpty(edit_url1.getText().toString())) {
                                    ToastUtils.showShort(GameActivity.this, "请将URL填写完整");
                                } else {
                                    //加载动画
                                    dialog.show();
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ToastUtils.showShort(GameActivity.this, "图片上传成功");
                    dialog.dismiss();
                    finish();
                    break;
                case 2:
                    ToastUtils.showShort(GameActivity.this, "图片上传失败");
                    dialog.dismiss();
                    break;
            }
        }
